...
urlpatterns = [
    ...
    path('select-city/', views.select_city_rajaongkir, name='select-city'),
    path('get-ongkir/', views.hit_ongkir, name='get-ongkir'),
    path('count-total', views.count_total, name="count-total")
